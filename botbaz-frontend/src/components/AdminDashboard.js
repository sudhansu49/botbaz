...
const AdminDashboard = () => {
  ...
  const recentActivity = [
    ...
    },
    {
      id: 2,
      type: "partner",
      title: "Partner created new client",
  ...
  const users = [
    { id: 1, name: "John Smith", email: "john@example.com", plan: "Growth", status: "active" },
    { id: 2, name: "Sarah Johnson", email: "sarah@example.com", plan: "Starter", status: "active" },
    { id: 3, name: "Michael Brown", email: "michael@example.com", plan: "Pro", status: "inactive" }
  ];

  const partners = [
    { id: 1, name: "Digital Marketing Agency", clients: 42, revenue: "₹12,482", status: "active" },
    { id: 2, name: "Tech Solutions Inc.", clients: 28, revenue: "₹8,756", status: "active" },
    { id: 3, name: "Growth Partners", clients: 15, revenue: "₹3,245", status: "inactive" }
  ];
        ...
        <div>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">Latest actions by users and partners</p>
            </div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="ml-2 flex-shrink-0 flex">
                            <p className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                              ...
                              activity.type === 'partner' ? 'bg-blue-100 text-blue-800' : 
      ...
      {activeTab === 'partners' && (
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6">
            ...
            <p className="mt-1 max-w-2xl text-sm text-gray-500">Manage all platform partners</p>
          </div>
          <div className="border-t border-gray-200">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
